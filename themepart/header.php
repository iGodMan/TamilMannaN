<header class="bg-black lter header header-md navbar navbar-fixed-top-xs">
            <div class="navbar-header aside bg-success nav-xs"> <a class="btn btn-link visible-xs"
                    data-toggle="class:nav-off-screen,open" data-target="#nav,html" href="musik.php"> <i
                        class="icon-list"></i> </a> <a href="index.php" class="navbar-brand text-lt"> <i
                        class="icon-earphones"></i> <img src="images/images-logo.png" alt="." class="hide"> <span
                        class="hidden-nav-xs m-l-sm">TamilMannan</span> </a> <a class="btn btn-link visible-xs"
                    data-toggle="dropdown" data-target=".user" href="musik.php"> <i class="icon-settings"></i> </a>
            </div>
                ...
                <!-- <ul class="nav navbar-nav m-n hidden-xs nav-user user">
                        ...
                        <section class="dropdown-menu aside-xl animated fadeInUp">
                            <section class="panel bg-white">
                                ...
                                <div class="list-group list-group-alt"> <a href="#" class="media list-group-item"> <span
                                            class="pull-left thumb-sm"> <img src="images/images-a0.png" alt="..."
                    ...
                    <li class="dropdown"> <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown"> <span
                                class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm"> <img
                                    src="images/images-a0.png" alt="..."> </span> John.Smith <b class="caret"></b> </a>
