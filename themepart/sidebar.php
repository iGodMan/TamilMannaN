            ...
            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0"
                ...
                <nav class="nav-primary hidden-xs">
                    <ul class="nav bg clearfix">
                        ...
                        <li> <a href="index.php"> <i class="icon-disc icon text-success"></i> <span
                                    class="font-bold">What's new</span> </a> </li>
                        <li> <a href="genres.php"> <i class="icon-music-tone-alt icon text-info"></i>
                                <span class="font-bold">Popular</span> </a> </li>
                        <li> <a href="events.php"> <i class="icon-drawer icon text-primary-lter"></i>
                                <b class="badge bg-primary pull-right">6</b> <span
                                    class="font-bold">Years</span> </a> </li>
                        <li> <a href="listen.php"> <i class="icon-list icon text-info-dker"></i> <span
                                    class="font-bold">A-Z</span> </a> </li>
                        <!-- <li> <a href="video.php" data-target="#content" data-el="#bjax-el"
                                data-replace="true"> <i
                    ...
                    <!-- <ul class="nav" data-ride="collapse">
                        ...
                        <li> <a href="#" class="auto"> <span class="pull-right text-muted"> <i
                            ...
                            <ul class="nav dk text-sm">
                                <li> <a href="layout-color.php" class="auto"> <i
                                            class="fa fa-angle-right text-xs"></i> <span>Color
                                            option</span> </a> </li>
                                <li> <a href="layout-boxed.php" class="auto"> <i
                                            class="fa fa-angle-right text-xs"></i> <span>Boxed
                                            layout</span> </a> </li>
                                <li> <a href="layout-fluid.php" class="auto"> <i
                        ...
                        <li> <a href="#" class="auto"> <span class="pull-right text-muted"> <i
                            ...
                            <ul class="nav dk text-sm">
                                ...
                                <li> <a href="#table" class="auto"> <span class="pull-right text-muted">
                                    ...
                                    <ul class="nav dker">
                                        <li> <a href="table-static.php"> <i
                                                    class="fa fa-angle-right"></i> <span>Table
                                                    static</span> </a> </li>
                                        <li> <a href="table-datatable.php"> <i
                                ...
                                <li> <a href="#form" class="auto"> <span class="pull-right text-muted">
                                    ...
                                    <ul class="nav dker">
                                        <li> <a href="form-elements.php"> <i
                                                    class="fa fa-angle-right"></i> <span>Form
                                                    elements</span> </a> </li>
                                        <li> <a href="form-validation.php"> <i
                                                    class="fa fa-angle-right"></i> <span>Form
                                                    validation</span> </a> </li>
                                        <li> <a href="form-wizard.php"> <i
                                                    class="fa fa-angle-right"></i> <span>Form
                                                    wizard</span> </a> </li>
                                    </ul>
                                </li>
                                <li> <a href="chart.php" class="auto"> <i
                                            class="fa fa-angle-right text-xs"></i> <span>Chart</span>
                                    </a> </li>
                                <li> <a href="portlet.php" class="auto"> <i
                                            class="fa fa-angle-right text-xs"></i> <span>Portlet</span>
                                    </a> </li>
                                <li> <a href="timeline.php" class="auto"> <i
            ...
            <div class="bg hidden-xs ">
                <!-- <div class="dropdown dropup wrapper-sm clearfix"> <a href="#" class="dropdown-toggle"
                        data-toggle="dropdown"> <span class="thumb-sm avatar pull-left m-l-xs"> <img
                                src="images/images-a3.png" class="dker" alt="..."> <i
                                class="on b-black"></i> </span> <span class="hidden-nav-xs clear"> <span
                                class="block m-l"> <strong class="font-bold text-lt">John.Smith</strong>
                                <b class="caret"></b> </span> <span
                                class="text-muted text-xs block m-l">Art Director</span> </span> </a>
                    <ul class="dropdown-menu animated fadeInRight aside text-left">
                        ...
                        <li class="divider"> </li>
                        <li> <a href="modal.lockme.php" data-toggle="ajaxModal">Logout</a> </li>
                    </ul>
                </div> -->
            </div>
        </footer>
